...
const DressStyle = () => {
  return (
    <div className="px-4 xl:px-0">
      <section className="max-w-frame mx-auto bg-coastal-sage px-6 pb-6 pt-10 md:p-[70px] rounded-[40px] text-center">
        <motion.h2
          ...
          className={cn([
            ...
            "text-[32px] leading-[36px] md:text-5xl mb-8 md:mb-14 capitalize text-coastal-darkBrown",
          ])}
        >
